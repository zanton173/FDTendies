...
if(isset($_POST['submit4'])){
    ...
    $DoThings->putawayPart($partNum, $linesUsed, 'A3Shelf4', $qty);
}elseif(isset($_POST['submit3'])){
    $partNum = $_POST['partNum3'];
    $linesUsed = $_POST['lines3'];
    $qty = $_POST['quantity3'];
    
    $DoThings->putawayPart($partNum, $linesUsed, 'A3Shelf3', $qty);
    ...
    $DoThings->putawayPart($partNum, $linesUsed, 'A3Shelf2', $qty);
    ...
    $DoThings->putawayPart($partNum, $linesUsed, 'A3Shelf1', $qty);
