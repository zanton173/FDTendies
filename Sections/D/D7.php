...
$query = "SELECT partNumber, linesUsed, qty FROM parts WHERE location='D7Shelf4'";
...
$query = "SELECT partNumber, linesUsed, qty FROM parts WHERE location='D7Shelf3'";
$result = mysqli_query(NewFile::establishConnection(), $query);
...
$shelfNumber = "Shelf2";
echo "<h5 style='text-decoration: underline; font-weight: bold;'>$shelfNumber</h5>";
$query = "SELECT partNumber, linesUsed, qty FROM parts WHERE location='D7Shelf2'";
$result = mysqli_query(NewFile::establishConnection(), $query);
...
$query = "SELECT partNumber, linesUsed, qty FROM parts WHERE location='D7Shelf1'";
$result = mysqli_query(NewFile::establishConnection(), $query);
