...
$query = "SELECT partNumber, linesUsed, qty FROM parts WHERE location='D10Shelf4'";
...
$query = "SELECT partNumber, linesUsed, qty FROM parts WHERE location='D10Shelf3'";
$result = mysqli_query(NewFile::establishConnection(), $query);
...
$shelfNumber = "Shelf2";
echo "<h5 style='text-decoration: underline; font-weight: bold;'>$shelfNumber</h5>";
$query = "SELECT partNumber, linesUsed, qty FROM parts WHERE location='D10Shelf2'";
$result = mysqli_query(NewFile::establishConnection(), $query);
...
$query = "SELECT partNumber, linesUsed, qty FROM parts WHERE location='D10Shelf1'";
$result = mysqli_query(NewFile::establishConnection(), $query);
...
?>
	...
	<!-- <form action='D10.php' method="post">  
