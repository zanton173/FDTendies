...
if(isset($_POST['submit4'])){
    ...
    $DoThings->putawayPart($partNum, $linesUsed, 'B6Shelf4', $qty);
}elseif(isset($_POST['submit3'])){
    $partNum = $_POST['partNum3'];
    $linesUsed = $_POST['lines3'];
    $qty = $_POST['quantity3'];
    
    $DoThings->putawayPart($partNum, $linesUsed, 'B6Shelf3', $qty);
    ...
    $DoThings->putawayPart($partNum, $linesUsed, 'B6Shelf2', $qty);
    ...
    $DoThings->putawayPart($partNum, $linesUsed, 'B6Shelf1', $qty);
