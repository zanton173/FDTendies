...
if(isset($_POST['submit4'])){
    ...
    $DoThings->putawayPart($partNum, $linesUsed, 'C1Shelf4', $qty);
}elseif(isset($_POST['submit3'])){
    $partNum = $_POST['partNum3'];
    $linesUsed = $_POST['lines3'];
    $qty = $_POST['quantity3'];
    
    $DoThings->putawayPart($partNum, $linesUsed, 'C1Shelf3', $qty);
    ...
    $DoThings->putawayPart($partNum, $linesUsed, 'C1Shelf2', $qty);
    ...
    $DoThings->putawayPart($partNum, $linesUsed, 'C1Shelf1', $qty);
