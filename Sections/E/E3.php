...
<h1 class="centering" style="font-size: 15pt; height: 25px">Hine
	Inventory Application</h1><h2 style='color: blue; font-size: 17pt;'>E3</h2>
<div class='centering'>
<h4>Pick Parts</h4>
<div class="row">
...
{
    $query = "SELECT id, partNumber, SUM(qty) AS qty FROM parts WHERE location=CONCAT('E3Shelf', '$j') GROUP BY partNumber ORDER BY partNumber DESC";
